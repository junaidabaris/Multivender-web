        ...
        <>
            <div className="aiz-main-content">
              ...
              <div class="alert alert-danger d-flex align-items-center">
                  ...
                  <a class="alert-link ml-2" href="https://mmslfashions.in/admin/smtp-settings">Configure Now</a>
              </div>
          </div*/}
                                ...
                                <div className="col-6">
                                    <div className="bg-grad-3 text-white rounded-lg mb-4 overflow-hidden">
                                        <div className="px-3 pt-3">
                                            ...
                                            <div className="h3 fw-700 mb-3">8</div>
                                        </div>
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
                                            <path fill="rgba(255,255,255,0.3)" fillOpacity={1} d="M0,128L34.3,112C68.6,96,137,64,206,96C274.3,128,343,224,411,250.7C480,277,549,235,617,213.3C685.7,192,754,192,823,181.3C891.4,171,960,149,1029,117.3C1097.1,85,1166,43,1234,58.7C1302.9,75,1371,149,1406,186.7L1440,224L1440,320L1405.7,320C1371.4,320,1303,320,1234,320C1165.7,320,1097,320,1029,320C960,320,891,320,823,320C754.3,320,686,320,617,320C548.6,320,480,320,411,320C342.9,320,274,320,206,320C137.1,320,69,320,34,320L0,320Z" />
                                        </svg>
                                ...
                                <div className="col-6">
                                    <div className="bg-grad-1 text-white rounded-lg mb-4 overflow-hidden">
                                        <div className="px-3 pt-3">
                                            ...
                                            <div className="h3 fw-700 mb-3">24</div>
                                        </div>
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
                                            <path fill="rgba(255,255,255,0.3)" fillOpacity={1} d="M0,128L34.3,112C68.6,96,137,64,206,96C274.3,128,343,224,411,250.7C480,277,549,235,617,213.3C685.7,192,754,192,823,181.3C891.4,171,960,149,1029,117.3C1097.1,85,1166,43,1234,58.7C1302.9,75,1371,149,1406,186.7L1440,224L1440,320L1405.7,320C1371.4,320,1303,320,1234,320C1165.7,320,1097,320,1029,320C960,320,891,320,823,320C754.3,320,686,320,617,320C548.6,320,480,320,411,320C342.9,320,274,320,206,320C137.1,320,69,320,34,320L0,320Z" />
                                        </svg>
                                ...
                                <div className="col-6">
                                    <div className="bg-grad-4 text-white rounded-lg mb-4 overflow-hidden">
                                        <div className="px-3 pt-3">
                                            ...
                                            <div className="h3 fw-700 mb-3">4</div>
                                        </div>
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
                                            <path fill="rgba(255,255,255,0.3)" fillOpacity={1} d="M0,128L34.3,112C68.6,96,137,64,206,96C274.3,128,343,224,411,250.7C480,277,549,235,617,213.3C685.7,192,754,192,823,181.3C891.4,171,960,149,1029,117.3C1097.1,85,1166,43,1234,58.7C1302.9,75,1371,149,1406,186.7L1440,224L1440,320L1405.7,320C1371.4,320,1303,320,1234,320C1165.7,320,1097,320,1029,320C960,320,891,320,823,320C754.3,320,686,320,617,320C548.6,320,480,320,411,320C342.9,320,274,320,206,320C137.1,320,69,320,34,320L0,320Z" />
                                        </svg>
                                ...
                                <div className="col-6">
                                    <div className="card">
                                        <div className="card-header">
                                            <h6 className="mb-0 fs-14">Products</h6>
                                        </div>
                                        <div className="card-body"><div className="chartjs-size-monitor"><div className="chartjs-size-monitor-expand"><div className /></div><div className="chartjs-size-monitor-shrink"><div className /></div></div>
                                            <canvas id="pie-1" className="w-100 chartjs-render-monitor" height={381} style={{ display: 'block', height: 305, width: 234 }} width={292} />
                                        </div>
                                    </div>
                                </div>
                                <div className="col-6">
                                    <div className="card">
                                        <div className="card-header">
                                            <h6 className="mb-0 fs-14">Sellers</h6>
                                        </div>
                                        <div className="card-body"><div className="chartjs-size-monitor"><div className="chartjs-size-monitor-expand"><div className /></div><div className="chartjs-size-monitor-shrink"><div className /></div></div>
                                            <canvas id="pie-2" className="w-100 chartjs-render-monitor" height={381} width={292} style={{ display: 'block', height: 305, width: 234 }} />
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className="row gutters-10">
                        <div className="col-md-6">
                            <div className="card">
                                <div className="card-header">
                                    <h6 className="mb-0 fs-14">Category wise product sale</h6>
                                </div>
                                <div className="card-body"><div className="chartjs-size-monitor"><div className="chartjs-size-monitor-expand"><div className /></div><div className="chartjs-size-monitor-shrink"><div className /></div></div>
                        ...
                        <div className="col-md-6">
                            <div className="card">
                                <div className="card-header">
                                    <h6 className="mb-0 fs-14">Category wise product stock</h6>
                                </div>
                                <div className="card-body"><div className="chartjs-size-monitor"><div className="chartjs-size-monitor-expand"><div className /></div><div className="chartjs-size-monitor-shrink"><div className /></div></div>
                                ...
                                <div className="aiz-card-box border border-light rounded shadow-sm hov-shadow-md mb-2 has-transition bg-white">
                                    <div className="position-relative">
                                        <a href="https://mmslfashions.in/product/ntrat-alamonyom" className="d-block" tabIndex={0}>
                                            <img className="img-fit mx-auto h-210px lazyloaded" src="https://mmslfashions.in/public/uploads/all/g7ZiaWNvwkLwNhl67jtfbUaIcwSzVarNuc7T8dLP.jpg" data-src="https://mmslfashions.in/public/uploads/all/g7ZiaWNvwkLwNhl67jtfbUaIcwSzVarNuc7T8dLP.jpg" alt="Ammonium Nitrate" onError="this.onError=null;this.src='https://mmslfashions.in/public/assets/img/placeholder.jpg';" />
                                        </a>
                                    </div>
                                    <div className="p-md-3 p-2 text-left">
                                        <div className="fs-15">
                                ...
                                <div className="aiz-card-box border border-light rounded shadow-sm hov-shadow-md mb-2 has-transition bg-white">
                                    <div className="position-relative">
                                        <a href="https://mmslfashions.in/product/map-granular-in-50kg-bag-mIbGj" className="d-block" tabIndex={0}>
                                            <img className="img-fit mx-auto h-210px lazyloaded" src="https://mmslfashions.in/public/uploads/all/Wiv7vhbeLmejHSA4L7NNWgfAqundcpdd76tW7OiY.jpg" data-src="https://mmslfashions.in/public/uploads/all/Wiv7vhbeLmejHSA4L7NNWgfAqundcpdd76tW7OiY.jpg" alt="MAP GRANULAR IN 50KG BAG" onError="this.onError=null;this.src='https://mmslfashions.in/public/assets/img/placeholder.jpg';" />
                                        </a>
                                    </div>
                                    <div className="p-md-3 p-2 text-left">
                                        <div className="fs-15">
                                ...
                                <div className="aiz-card-box border border-light rounded shadow-sm hov-shadow-md mb-2 has-transition bg-white">
                                    <div className="position-relative">
                                        <a href="https://mmslfashions.in/product/ammonium-sulphate-3" className="d-block" tabIndex={0}>
                                            <img className="img-fit mx-auto h-210px lazyloaded" src="https://mmslfashions.in/public/uploads/all/yVOr0O2yV6y4EcW47YAkrl2w77aQG5yXYGYLcZFD.png" data-src="https://mmslfashions.in/public/uploads/all/yVOr0O2yV6y4EcW47YAkrl2w77aQG5yXYGYLcZFD.png" alt="Ammonium Sulphate" onError="this.onError=null;this.src='https://mmslfashions.in/public/assets/img/placeholder.jpg';" />
                                        </a>
                                    </div>
                                    <div className="p-md-3 p-2 text-left">
                                        <div className="fs-15">
                                ...
                                <div className="aiz-card-box border border-light rounded shadow-sm hov-shadow-md mb-2 has-transition bg-white">
                                    <div className="position-relative">
                                        <a href="https://mmslfashions.in/product/171717" className="d-block" tabIndex={0}>
                                            <img className="img-fit mx-auto h-210px lazyloaded" src="https://mmslfashions.in/public/uploads/all/v01lSDffgSnZK0HXzyIvBNgzdjnlIuolRvWXoCMA.jpg" data-src="https://mmslfashions.in/public/uploads/all/v01lSDffgSnZK0HXzyIvBNgzdjnlIuolRvWXoCMA.jpg" alt="17:17:17" onError="this.onError=null;this.src='https://mmslfashions.in/public/assets/img/placeholder.jpg';" />
                                        </a>
                                    </div>
                                    <div className="p-md-3 p-2 text-left">
                                        <div className="fs-15">
                                ...
                                <div className="aiz-card-box border border-light rounded shadow-sm hov-shadow-md mb-2 has-transition bg-white">
                                    <div className="position-relative">
                                        <a href="https://mmslfashions.in/product/ammonium-sulphate-xlnf4" className="d-block" tabIndex={0}>
                                            <img className="img-fit mx-auto h-210px lazyloaded" src="https://mmslfashions.in/public/uploads/all/Wiv7vhbeLmejHSA4L7NNWgfAqundcpdd76tW7OiY.jpg" data-src="https://mmslfashions.in/public/uploads/all/Wiv7vhbeLmejHSA4L7NNWgfAqundcpdd76tW7OiY.jpg" alt="Ammonium Sulphate" onError="this.onError=null;this.src='https://mmslfashions.in/public/assets/img/placeholder.jpg';" />
                                        </a>
                                    </div>
                                    <div className="p-md-3 p-2 text-left">
                                        <div className="fs-15">
                                ...
                                <div className="aiz-card-box border border-light rounded shadow-sm hov-shadow-md mb-2 has-transition bg-white">
                                    <div className="position-relative">
                                        <a href="https://mmslfashions.in/product/ammonium-nitrate-10-kg-bag-8FauO" className="d-block" tabIndex={-1}>
                                            <img className="img-fit mx-auto h-210px lazyloaded" src="https://mmslfashions.in/public/uploads/all/Wiv7vhbeLmejHSA4L7NNWgfAqundcpdd76tW7OiY.jpg" data-src="https://mmslfashions.in/public/uploads/all/Wiv7vhbeLmejHSA4L7NNWgfAqundcpdd76tW7OiY.jpg" alt="AMMONIUM NITRATE 10 KG BAG" onError="this.onError=null;this.src='https://mmslfashions.in/public/assets/img/placeholder.jpg';" />
                                        </a>
                                    </div>
                                    <div className="p-md-3 p-2 text-left">
                                        <div className="fs-15">
                                ...
                                <div className="aiz-card-box border border-light rounded shadow-sm hov-shadow-md mb-2 has-transition bg-white">
                                    <div className="position-relative">
                                        <a href="https://mmslfashions.in/product/17-17-17-50-kg-bag-mNH9f" className="d-block" tabIndex={-1}>
                                            <img className="img-fit mx-auto h-210px lazyloaded" src="https://mmslfashions.in/public/uploads/all/Wiv7vhbeLmejHSA4L7NNWgfAqundcpdd76tW7OiY.jpg" data-src="https://mmslfashions.in/public/uploads/all/Wiv7vhbeLmejHSA4L7NNWgfAqundcpdd76tW7OiY.jpg" alt="17:17:17  50 KG BAG" onError="this.onError=null;this.src='https://mmslfashions.in/public/assets/img/placeholder.jpg';" />
                                        </a>
                                    </div>
                                    <div className="p-md-3 p-2 text-left">
                                        <div className="fs-15">
                                ...
                                <div className="aiz-card-box border border-light rounded shadow-sm hov-shadow-md mb-2 has-transition bg-white">
                                    <div className="position-relative">
                                        <a href="https://mmslfashions.in/product/ammonium-nitrate-25-kg-bag-PJCsc" className="d-block" tabIndex={-1}>
                                            <img className="img-fit mx-auto h-210px ls-is-cached lazyloaded" src="https://mmslfashions.in/public/uploads/all/Wiv7vhbeLmejHSA4L7NNWgfAqundcpdd76tW7OiY.jpg" data-src="https://mmslfashions.in/public/uploads/all/Wiv7vhbeLmejHSA4L7NNWgfAqundcpdd76tW7OiY.jpg" alt="AMMONIUM NITRATE 25 KG BAG" onError="this.onError=null;this.src='https://mmslfashions.in/public/assets/img/placeholder.jpg';" />
                                        </a>
                                    </div>
                                    <div className="p-md-3 p-2 text-left">
                                        <div className="fs-15">
                                ...
                                <div className="aiz-card-box border border-light rounded shadow-sm hov-shadow-md mb-2 has-transition bg-white">
                                    <div className="position-relative">
                                        <a href="https://mmslfashions.in/product/ammonium-nitrate-5-kg-bag-oq9VC" className="d-block" tabIndex={-1}>
                                            <img className="img-fit lazyload mx-auto h-210px" src="https://mmslfashions.in/public/assets/img/placeholder.jpg" data-src="https://mmslfashions.in/public/uploads/all/Wiv7vhbeLmejHSA4L7NNWgfAqundcpdd76tW7OiY.jpg" alt="AMMONIUM NITRATE 5 KG BAG" onError="this.onError=null;this.src='https://mmslfashions.in/public/assets/img/placeholder.jpg';" />
                                        </a>
                                    </div>
                                    <div className="p-md-3 p-2 text-left">
                                        <div className="fs-15">
                                ...
                                <div className="aiz-card-box border border-light rounded shadow-sm hov-shadow-md mb-2 has-transition bg-white">
                                    <div className="position-relative">
                                        <a href="https://mmslfashions.in/product/ammonium-nitrate-in-50-kg-bag-ieimd" className="d-block" tabIndex={-1}>
                                            <img className="img-fit lazyload mx-auto h-210px" src="https://mmslfashions.in/public/assets/img/placeholder.jpg" data-src="https://mmslfashions.in/public/uploads/all/Wiv7vhbeLmejHSA4L7NNWgfAqundcpdd76tW7OiY.jpg" alt="AMMONIUM NITRATE IN 50 KG BAG" onError="this.onError=null;this.src='https://mmslfashions.in/public/assets/img/placeholder.jpg';" />
                                        </a>
                                    </div>
                                    <div className="p-md-3 p-2 text-left">
                                        <div className="fs-15">
