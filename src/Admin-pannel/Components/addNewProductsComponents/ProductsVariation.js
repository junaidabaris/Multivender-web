                ...
                <div className="card-body">
                    <div className="form-group row gutters-5">
                        <div className="col-md-3">
                            <input type="text" className="form-control" defaultValue="Colors" disabled fdprocessedid="onzz4" />
                        </div>
                        <div className="col-md-8">
                            <div className="dropdown bootstrap-select show-tick disabled form-control aiz-"><select className="form-control aiz-selectpicker" data-live-search="true" data-selected-text-format="count" name="colors[]" id="colors" multiple disabled tabIndex={-98}>
                    ...
                    <div className="form-group row gutters-5">
                        <div className="col-md-3">
                            <input type="text" className="form-control" defaultValue="Attributes" disabled fdprocessedid="9mqiul" />
                        </div>
                        <div className="col-md-8">
                            <div className="dropdown bootstrap-select show-tick form-control aiz-"><select name="choice_attributes[]" id="choice_attributes" className="form-control aiz-selectpicker" data-selected-text-format="count" data-live-search="true" multiple data-placeholder="Choose Attributes" tabIndex={-98}>
                                <option value={1}>Size</option>
                                <option value={2}>Fabric</option>
                            </select><button type="button" className="btn dropdown-toggle btn-light bs-placeholder" data-toggle="dropdown" role="combobox" aria-owns="bs-select-5" aria-haspopup="listbox" aria-expanded="false" data-id="choice_attributes" title="Nothing selected" fdprocessedid="adpqve"><div className="filter-option"><div className="filter-option-inner"><div className="filter-option-inner-inner">Nothing selected</div></div> </div></button><div className="dropdown-menu "><div className="bs-searchbox"><input type="search" className="form-control" autoComplete="off" role="combobox" aria-label="Search" aria-controls="bs-select-5" aria-autocomplete="list" /></div><div className="inner show" role="listbox" id="bs-select-5" tabIndex={-1} aria-multiselectable="true"><ul className="dropdown-menu inner show" role="presentation" /></div></div></div>
                        </div>
                    </div>
                    <div>
