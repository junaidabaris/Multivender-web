        ...
        <tbody>
          <tr>
            <td className="footable-first-visible" style={{display: 'table-cell'}}>
              ...
              <a href="https://mmslfashions.in/purchase_history/details/eyJpdiI6Im5tRm00cC91RUltd2ZNUHcrVjJtbmc9PSIsInZhbHVlIjoibEdadVBaSlEvK1phR3YzRWZNajJDUT09IiwibWFjIjoiNTRmMWM2ZTdhMjFjN2NjN2IyMjhiYzUyZDhkN2I1YzlkMjAyNDA4YThmM2EzMGZiM2RjYmQ3ZDBjZWE0MDJlZCIsInRhZyI6IiJ9" className="btn btn-soft-info btn-icon btn-circle btn-sm" title="Order Details">
            ...
            <td className="footable-first-visible" style={{display: 'table-cell'}}>
              ...
              <a href="https://mmslfashions.in/purchase_history/details/eyJpdiI6Ijdvc05nM0JsV3lsb0JyUHhHbEQ4MkE9PSIsInZhbHVlIjoiZFQrUXdWNG5IL3ErS0Z4dlhjR29Cdz09IiwibWFjIjoiM2MwMjEyZGE4ZDgyMTc1OTJiM2EyMDI1ZjQyZGUwNzE0OTY4N2M1MDFmY2UwMDQ2YzRkMjczZmExNmU4NDE5ZCIsInRhZyI6IiJ9" className="btn btn-soft-info btn-icon btn-circle btn-sm" title="Order Details">
                <i className="las la-eye" />
              </a>
            ...
            <td className="footable-first-visible" style={{display: 'table-cell'}}>
              ...
              <a href="https://mmslfashions.in/purchase_history/details/eyJpdiI6Ijk4MHQ4ZEhKOWZ5c3NYNmdqQmRIL3c9PSIsInZhbHVlIjoibzZOUkp6eUxFWDJ2NVFzSVp6Y2gzQT09IiwibWFjIjoiZmZmM2Y3NWJkNzIwNjhiNTRiNDU1Nzg3NjQ3MDZiNzY3OTVhNGMwOTE1NmZlNmZiY2IxZGM0MmI4NzYyZGUyOCIsInRhZyI6IiJ9" className="btn btn-soft-info btn-icon btn-circle btn-sm" title="Order Details">
                <i className="las la-eye" />
              </a>
            ...
            <td className="footable-first-visible" style={{display: 'table-cell'}}>
              ...
              <a href="https://mmslfashions.in/purchase_history/details/eyJpdiI6InlkbDkvRXBIdUxhWDhqZWdmMjg5SWc9PSIsInZhbHVlIjoiUzY3dzJ2dmIyR0FYUkRmQ1d0QUg5Zz09IiwibWFjIjoiODMwYmJmODc3ZjVmYjY4MzE4ZDQ3MThlMzU3NGJjODcyN2MzNTVkOTVjNDQ4Nzk2NTQ3MTNhNWU3YTc2YWFiNCIsInRhZyI6IiJ9" className="btn btn-soft-info btn-icon btn-circle btn-sm" title="Order Details">
                <i className="las la-eye" />
              </a>
