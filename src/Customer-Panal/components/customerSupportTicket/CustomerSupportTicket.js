            ...
            <div className="aiz-user-panel">
                ...
                <div className="row">
                    <div className="col-md-4 mx-auto mb-3">
                        <div className="p-3 rounded mb-3 c-pointer text-center bg-white shadow-sm hov-shadow-lg has-transition" data-toggle="modal" data-target="#ticket_modal" onClick={handleShow}>
                        ...
                        <Modal show={show} onHide={handleClose} dialogClassName="modal-wrapper">
                            <Modal.Header closeButton>
                                <Modal.Title>Modal heading fseds</Modal.Title>
                            </Modal.Header>
                            <Modal.Body>
                                <div className="modal-body px-3 pt-3">
                                    <form className action="https://mmslfashions.in/support_ticket" method="post" encType="multipart/form-data">
                                        <input type="hidden" name="_token" defaultValue="U2LxNDQI02RGvLhiujII5Z0PRiirIALmEGz5cy59" />                      <div className="row">
                                        ...
                                        <div className="row">
                                            ...
                                            <div className="col-md-10">
                                                <textarea type="text" className="form-control mb-3" rows={3} name="details" placeholder="Type your reply" data-buttons="bold,underline,italic,|,ul,ol,|,paragraph,|,undo,redo" required defaultValue={""} />
                                            </div>
                                        </div>
                                        <div className="form-group row">
                                            ...
                                            <div className="col-md-10">
                                                <div className="input-group" data-toggle="aizuploader" data-type="image" data-multiple="true">
                                                    ...
                                                    <div className="form-control file-amount" onClick={handleShowInner}>Choose File</div>
                                            ...
                                            <Modal show={innerShow} onHide={handleCloseInner} dialogClassName='remove-model-height'>
                                                <Modal.Header closeButton>
                                                                ...
                                                                <div className="aiz-uploader-filter pt-1 pb-3 border-bottom mb-4">
                                                                    <div className="row align-items-center gutters-5 gutters-md-10 position-relative">
                                                                        <div className="col-xl-2 col-md-3 col-5">
                                                                            <div className>
                                                                                {/* Input */}
                                                                                <select className="form-control form-control-xs aiz-selectpicker" name="aiz-uploader-sort" fdprocessedid="r5b6xg">
                                                                        ...
                                                                        <div className="col-md-4 col-xl-3 ml-auto mr-0 col-2 position-static">
                                                                            <div className="aiz-uploader-search text-right">
                                                                                <input type="text" className="form-control form-control-xs" name="aiz-uploader-search" placeholder="Search your files" fdprocessedid="fo65fr" />
                                                                                <i className="search-icon d-md-none"><span /></i>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div className="aiz-uploader-all clearfix c-scrollbar-light"><div className="aiz-file-box-wrap" aria-hidden="false" data-selected="false"><div className="aiz-file-box"><div className="card card-file aiz-uploader-select" title="Kynoch-Logo-PNG.png" data-value={2}><div className="card-file-thumb"><img src="//mmslfashions.in/public/uploads/all/hz9Ng3hFHB2oQUvOb5dFqHn8Pfens0vc8ewiYZC7.png" className="img-fit" /></div><div className="card-body"><h6 className="d-flex"><span className="text-truncate title">Kynoch-Logo-PNG</span><span className="ext flex-shrink-0">.png</span></h6><p>30 KB</p></div></div></div></div></div>
                                                            </div>
                                                    ...
                                                    <div className="modal-footer justify-content-between bg-light">
                                                        <div className="flex-grow-1 overflow-hidden d-flex">
                                                            <div className>
                                                                ...
                                                                <button type="button" className="btn-link btn btn-sm p-0 aiz-uploader-selected-clear" fdprocessedid="78f39w">Clear</button>
                                                            </div>
                                                            <div className="mb-0 ml-3 file-select-btn">
                                                                <button type="button" className="btn btn-sm btn-primary" id="uploader_prev_btn" fdprocessedid="pmqcea" disabled="disabled">Prev</button>
                                                                <button type="button" className="btn btn-sm btn-primary" id="uploader_next_btn" fdprocessedid="yq4c8k" disabled="disabled">Next</button>
                                                            </div>
                                                        </div>
                                                        <button type="button" className="btn btn-sm btn-primary" data-toggle="aizUploaderAddSelected" fdprocessedid="l29hra">Add Files</button>
                                                    </div>
                                                </Modal.Body>
                                                <Modal.Footer>
                            ...
                            <tbody>
                                <tr>
                                    <td className="footable-first-visible" style={{ display: 'table-cell' }}>#1000003631</td><td style={{ display: 'table-cell' }}>2023-01-22 11:12:39</td><td style={{ display: 'table-cell' }}>Good evening, top urgently send my item to home delivery address. Thanks.</td><td style={{ display: 'table-cell' }}>
                                        ...
                                        <a href="https://mmslfashions.in/support_ticket/eyJpdiI6ImlFU2VIUGdSUnNISmNmMnhqQytORkE9PSIsInZhbHVlIjoiOUtlbHdHbWV5ZForaElrbUZtQVBRdz09IiwibWFjIjoiNDczMjdkNThmZWNiZTFlNjA0Y2EwNDEwMDRhOThlOGM0NjEzZGNhYzE2ZGFlMTQ0YjYzNDYxZGI2NWNkMGY1OSIsInRhZyI6IiJ9" className="btn btn-styled btn-link py-1 px-0 icon-anim text-underline--none">
                                            View Details
